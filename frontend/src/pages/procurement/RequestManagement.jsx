...
export default function RequestManagement() {
    ...
    return (
        <div className="space-y-6 pb-20 max-w-5xl mx-auto p-4 sm:p-6">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Incoming Material Requests</h1>
                        <p className="text-gray-500 text-sm">From Store In-charge regarding missing or low stock items</p>
                    </div>
                </div>
                <button 
            ...
            <div className="flex gap-4 border-b border-gray-200 -mt-2 pb-0">
                ...
                <a href="#/procurement/requests" className="px-1 py-2 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600">Store Req</a>
            </div>
