...
const NAV_CONFIG = {
    ...
    store_incharge: [
        ...
        {label: 'Internal MFG', icon: '🏭', path: '/manufacturing/logs'},
        {label: 'MFG Approvals', icon: '⚖️', path: '/manufacturing/approvals'},
        { label: 'Procurement Req', icon: '📝', path: '/store/requests' },
        { label: 'Samples', icon: '🎁', path: '/store/samples' },
        { label: 'Products', icon: '📦', path: '/store/products' },
    ...
    procurement: [
        ...
        { label: 'Vendors', icon: '🚚', path: '/procurement/vendors' },
    ...
    manufacturing_manager: [
        { label: 'MFG Dashboard', icon: '🏭', path: '/manufacturing' },
        { label: 'RM Stock', icon: '🏗️', path: '/store/raw-materials' },
        { label: 'Chat', icon: '💬', path: '/chat', badge: true },
    ],
    admin: [
